package com.posco.education.jwt;
...
public class JwtAuthenticationFilter extends GenericFilterBean {
    ...
    private String resolveToken(HttpServletRequest request) {
        ...
        Enumeration<String> authorization = request.getHeaders("access-control-request-headers");
        while(authorization.hasMoreElements()) {
            System.out.println(authorization.nextElement());
        }
